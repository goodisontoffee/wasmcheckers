...
(func $shownCrown (param $pieceY i32) (param $piece i32) (result i32)
  (i32.or
    (i32.and
      (i32.eq
        (get_local $pieceY)
...
;; Converts a piece into a crown piece and invokes
;; a host notifier
...
(func $do_move (param $fromX i32) (param $fromY i32) (param $toX i32) (param $toY i32) (result i32)
  ...
  (if (call $shownCrown (get_local $toY) (get_local $curpiece))
